...
#                print('%s is %s with size of %i' % (names[i], d[names[i]], arraysize))
...
class PrimaryMonitor(object):
    ...
    def __init__(self, host, use_simulation=False):
        ...
        self._trystop = True  # to stop thread
        self.running = True  # True when robot is on and listening
    ...
    def connect(self):
        primary_port = 30011    # Secondary client interface on Universal Robots
    ...
    def send_program(self, prog):
        ...
        data = Program(prog + b"\n")
        self._s_primary.send(data.program)
    ...
    def _get_data(self):
        ...
        """
        tmp = self._s_primary.recv(20480)
        return tmp
        self._dataqueue = b''
        while True:
            ...
            if ans:
                ...
                try:
                    ...
                    print("timeout in the secondary socket.")
